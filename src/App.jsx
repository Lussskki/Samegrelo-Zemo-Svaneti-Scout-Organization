...
export default function App() {
  ...
  const content = {
    'ქარ': {
      ...
      eduCard5D: <p>
                  გახდი ენერგოეფექტურობის სპეციალისტი – სამეგრელოს სკაუტური მოძრაობის ორგანიზაციის წარმატებული პროექტი! ⚡🌱<br /><br />
                  პროექტის მიზანი იყო საზოგადოებაში ენერგოეფექტურობის პრინციპებზე ცნობიერების ამაღლება და ენერგიის დაზოგვის პრაქტიკული ჩვევების დაუფლება.<br /><br />
                  📌 საქართველოს ენერგეტიკული სექტორის რეფორმის პროგრამა (GESRP) ხორციელდება ევროკავშირისა და Kreditanstalt für Wiederaufbau (KfW)-ის ფინანსური მხარდაჭერით.<br /><br />
                  პროექტს ახორციელებს საერთაშორისო კონსორციუმი intec, GOPA-International Energy Consultants GmbH-ის ხელმძღვანელობით, ხოლო რეგიონალურ ენერგოეფექტურობის კამპანიას შპს MES ახორციელებს.
                </p>, 
