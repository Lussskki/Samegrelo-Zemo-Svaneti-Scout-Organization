...
export default function App() {
  ...
  const content = {
    'ქარ': {
      ...
      eduCard1D: `წითელ ჯვართან პარტნიორობის ფარგლებში, ჩვენი გუნდი პანდემიის დროს წინა ხაზზე იდგა, რათა დახმარებოდა ყველზე მოწყვლად ჯგუფებს. 
                  ჩვენ წამოვიწყეთ ცნობიერების ამაღლებისა და საქველმოქმედო კამპანიაები. სკაუტები კრიზისის საწყის ეტაპზე ყველაზე ცხელ წერტილებში ვიდექით. 
                  სკაუტის მოვალებობაა იყოს სარგებლიანი და დაეხმაროს სხვას !`,
